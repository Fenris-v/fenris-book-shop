insert into authors (name, slug, photo, description)
values ('Theresita Trahear', 'suscipit', 'https://robohash.org/doloresfugiatrerum.png?size=50x50&set=set1',
...
insert into authors (name, slug, photo, description)
values ('Henry Morlon', 'egestas', 'https://robohash.org/cupiditateetquia.png?size=50x50&set=set1',
        'In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus.');
insert into authors (name, slug, photo, description)
values ('Bordy Freschini', 'tempus',
        'https://robohash.org/perferendisetvoluptas.png?size=50x50&set=set1',
...
insert into authors (name, slug, photo, description)
values ('Fannie Coste', 'quis', 'https://robohash.org/verosedomnis.png?size=50x50&set=set1',
        'Curabitur at ipsum ac tellus semper interdum. Mauris ullamcorper purus sit amet nulla. Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam.');
insert into authors (name, slug, photo, description)
values ('Stephine O''Giany', 'cubilia',
        'https://robohash.org/absimiliqueadipisci.png?size=50x50&set=set1',
        'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.');
insert into authors (name, slug, photo, description)
values ('Lissy Kenny', 'duis',
        'https://robohash.org/accusantiumnihilmaxime.png?size=50x50&set=set1',
        'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem. Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus. Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus.');
insert into authors (name, slug, photo, description)
values ('Huntington Tatteshall', 'penatibus',
        'https://robohash.org/nonoditiste.png?size=50x50&set=set1',
...
insert into authors (name, slug, photo, description)
values ('Kennett Comfort', 'velit',
        'https://robohash.org/eaquesuntincidunt.png?size=50x50&set=set1',
...
insert into authors (name, slug, photo, description)
values ('Orion McElrath', 'porta',
        'https://robohash.org/quiarepellatsit.png?size=50x50&set=set1',
...
insert into authors (name, slug, photo, description)
values ('Nikoletta Fossett', 'nulla',
        'https://robohash.org/autemdolorempraesentium.png?size=50x50&set=set1',
        'Aenean fermentum. Donec ut mauris eget massa tempor convallis. Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh. Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.');
insert into authors (name, slug, photo, description)
values ('Dimitri Lambersen', 'aliquam',
        'https://robohash.org/similiquevelexcepturi.png?size=50x50&set=set1',
        'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum. Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est. Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum.');
insert into authors (name, slug, photo, description)
values ('Constantina Douse', 'lorem', 'https://robohash.org/suntvelsapiente.png?size=50x50&set=set1',
        'Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.');
insert into authors (name, slug, photo, description)
values ('Duky Arnau', 'praesent',
        'https://robohash.org/asperiorestemporasunt.png?size=50x50&set=set1',
...
insert into authors (name, slug, photo, description)
values ('Blinnie Glaserman', 'eleifend',
        'https://robohash.org/quisundesoluta.png?size=50x50&set=set1',
        'Vestibulum ac est lacinia nisi venenatis tristique. Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat.');
insert into authors (name, slug, photo, description)
values ('Nerte Kilkenny', 'amet',
        'https://robohash.org/vitaeofficiisvoluptas.png?size=50x50&set=set1',
...
insert into authors (name, slug, photo, description)
values ('Basile Grumble', 'sapien',
        'https://robohash.org/molestiaeconsequaturquisquam.png?size=50x50&set=set1',
        'Suspendisse potenti. In eleifend quam a odio. In hac habitasse platea dictumst.');
insert into authors (name, slug, photo, description)
values ('Becka Taaffe', 'congue',
        'https://robohash.org/dolordolormagni.png?size=50x50&set=set1',
...
insert into authors (name, slug, photo, description)
values ('Matthiew Izaks', 'odio',
        'https://robohash.org/estofficiisfuga.png?size=50x50&set=set1',
...
insert into authors (name, slug, photo, description)
values ('Gerrie Lohoar', 'morbi',
        'https://robohash.org/corruptiquibusdamenim.png?size=50x50&set=set1',
...
insert into authors (name, slug, photo, description)
values ('Natasha Tarney', 'volutpat',
        'https://robohash.org/eumrepellenduset.png?size=50x50&set=set1',
        'Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh.');
insert into authors (name, slug, photo, description)
values ('Naoma Laingmaid', 'lectus',
        'https://robohash.org/dolorumminimasimilique.png?size=50x50&set=set1',
...
insert into genres (parent_id, slug, name)
values (null, 'nulla', 'at');
insert into genres (parent_id, slug, name)
values (1, 'auctor', 'mauris eget massa');
insert into genres (parent_id, slug, name)
values (2, 'urna', 'sapien quis libero');
insert into genres (parent_id, slug, name)
values (1, 'lobortis', 'massa');
insert into genres (parent_id, slug, name)
values (2, 'nulla2', 'neque');
insert into genres (parent_id, slug, name)
values (null, 'mollis', 'justo');
insert into genres (parent_id, slug, name)
values (null, 'blandit', 'pretium');
insert into genres (parent_id, slug, name)
values (1, 'commodo', 'nulla nunc');
insert into genres (parent_id, slug, name)
values (5, 'ante', 'velit');
insert into genres (parent_id, slug, name)
values (6, 'est', 'duis bibendum');
insert into genres (parent_id, slug, name)
values (null, 'platea', 'pretium nisl ut');
insert into genres (parent_id, slug, name)
values (null, 'placerat', 'lacus');
insert into genres (parent_id, slug, name)
values (null, 'convallis', 'semper interdum mauris');
insert into genres (parent_id, slug, name)
values (null, 'habitasse', 'neque sapien placerat');
insert into genres (parent_id, slug, name)
values (null, 'in', 'vulputate vitae nisl');
insert into genres (parent_id, slug, name)
values (1, 'integer', 'mi nulla');
insert into genres (parent_id, slug, name)
values (14, 'sagittis', 'molestie lorem');
insert into genres (parent_id, slug, name)
values (null, 'nulla5', 'lacus2');
insert into genres (parent_id, slug, name)
values (18, 'rhoncus', 'integer pede justo');
insert into genres (parent_id, slug, name)
values (6, 'fermentum', 'aenean sit amet');
insert into genres (parent_id, slug, name)
values (20, 'tincidunt', 'magna at');
insert into genres (parent_id, slug, name)
values (null, 'consequat', 'nec');
insert into genres (parent_id, slug, name)
values (null, 'sit', 'ut');
insert into genres (parent_id, slug, name)
values (2, 'tincidunt2', 'cursus urna');
insert into genres (parent_id, slug, name)
values (1, 'nulla3', 'at velit vivamus');
insert into genres (parent_id, slug, name)
values (5, 'venenatis', 'donec pharetra magna');
insert into genres (parent_id, slug, name)
values (26, 'mus', 'ut massa volutpat');
insert into genres (parent_id, slug, name)
values (null, 'sapien', 'proin risus');
insert into genres (parent_id, slug, name)
values (null, 'penatibus', 'a odio in');
insert into genres (parent_id, slug, name)
values (28, 'habitasse2', 'massa tempor convallis');
insert into genres (parent_id, slug, name)
values (30, 'luctus', 'arcu libero');
insert into genres (parent_id, slug, name)
values (6, 'adipiscing', 'non quam nec');
insert into genres (parent_id, slug, name)
values (22, 'ut', 'ultrices');
insert into genres (parent_id, slug, name)
values (null, 'non', 'turpis integer aliquet');
insert into genres (parent_id, slug, name)
values (4, 'eu', 'vestibulum sed');
insert into genres (parent_id, slug, name)
values (15, 'est2', 'volutpat');
insert into genres (parent_id, slug, name)
values (9, 'id', 'parturient montes nascetur');
insert into genres (parent_id, slug, name)
values (null, 'orci', 'cras');
insert into genres (parent_id, slug, name)
values (null, 'ut2', 'nullam porttitor lacus');
insert into genres (parent_id, slug, name)
values (1, 'ac', 'sem praesent');
insert into genres (parent_id, slug, name)
values (null, 'ultrices', 'eu orci');
insert into genres (parent_id, slug, name)
values (null, 'metus', 'lacus morbi sem');
insert into genres (parent_id, slug, name)
values (7, 'lacus', 'nisi vulputate');
insert into genres (parent_id, slug, name)
values (null, 'eu2', 'integer');
insert into genres (parent_id, slug, name)
values (10, 'ante1', 'gravida nisi');
insert into genres (parent_id, slug, name)
values (null, 'sit1', 'id');
insert into genres (parent_id, slug, name)
values (6, 'sit2', 'quam pede');
insert into genres (parent_id, slug, name)
values (24, 'lobortis1', 'tortor sollicitudin mi');
insert into genres (parent_id, slug, name)
values (8, 'venenatis1', 'ut nulla');
insert into genres (parent_id, slug, name)
values (36, 'duis', 'in purus');
